...
set "PYTHONPATH=%~dp0;%~dp0..\Argus_venv\Lib\site-packages;%PYTHONPATH%"
set "TRANSFORMERS_VERBOSITY=error"
set "STREAM_LOG_LEVEL=error"
set "PYTHONWARNINGS=ignore"

start http://localhost:8501
..\Argus_venv\Scripts\python.exe -m streamlit run ..\app\GUI\app.py --server.port 8501 --server.headless true --server.enableCORS false --server.enableXsrfProtection false
