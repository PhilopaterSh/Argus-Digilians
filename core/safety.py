"""
Argus Safety Layer - Blocks destructive payloads, sanitizes inputs.
...
class SafetyLayer:
    ...
    def sanitize_input(self, text: str) -> str:
        ...
        # Remove shell special chars that could cause injection
        dangerous_chars = ['`', '$(']
                ...
                if not self.allow_internal:
                    for private_range in PRIVATE_RANGES:
                        if ip in private_range:
                            ...
                            return False, f"Target IP {host} is in a private range. Use --allow-internal flag for internal testing."
            except ValueError:
