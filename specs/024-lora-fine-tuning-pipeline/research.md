...
`specs/028/research.md`'s follow-up section researches whether RLHF (or the newer agentic-RL
...
`019`/`028`) if Argus ever builds real RL training infrastructure beyond SFT.
